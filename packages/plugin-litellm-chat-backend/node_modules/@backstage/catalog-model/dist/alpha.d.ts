import { E as Entity$1, K as KindValidator, A as ApiEntityV1alpha1 } from './types/ApiEntityV1alpha1.d-BhMjnye_.js';
export { a as EntityLink, b as EntityMeta, c as EntityRelation } from './types/ApiEntityV1alpha1.d-BhMjnye_.js';
...
interface CatalogModel {
    ...
    getRelations(options: {
        kind: string;
    }): CatalogModelRelation[] | undefined;
}
/**
 ...
 * @alpha
 */
interface CatalogModelKindSummary {
    /**
     * A human-readable description of the kind.
     */
    description: string;
 ...
 * @alpha
 */
interface CatalogModelRelation {
    /**
 ...
 * @alpha
 */
interface CatalogModelAnnotationSummary {
    /**
 ...
 * @alpha
 */
interface CatalogModelLabelSummary {
    /**
 ...
 * @alpha
 */
interface CatalogModelTagSummary {
    /**
 ...
 * @alpha
 */
interface CatalogModelRelationSummary {
    /**
     * The kinds that this relation can originate from.
     */
    fromKind: string[];
 ...
 */
declare function compileCatalogModel(inputs: Iterable<CatalogModelLayer>): CatalogModel;
 ...
 * @alpha
 */
interface CatalogModelAnnotationDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelKindDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelKindVersionDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelKindRelationFieldDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelAddKindVersionDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelLabelDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelRelationPairDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelRemoveAnnotationDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelRemoveKindDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelRemoveLabelDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelRemoveTagDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelTagDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelUpdateAnnotationDefinition {
    /**
     * The name of the annotation, e.g. "backstage.io/techdocs-ref".
     */
    name: string;
 ...
 * @alpha
 */
interface CatalogModelUpdateKindDefinition {
    /**
     * The names used for this kind.
     */
    names: {
 ...
 * @alpha
 */
interface CatalogModelUpdateKindVersionDefinition {
    /**
 ...
 * @alpha
 */
interface CatalogModelUpdateLabelDefinition {
    /**
     * The name of the label, e.g. "backstage.io/source-location".
     */
    name: string;
 ...
 * @alpha
 */
interface CatalogModelUpdateRelationPairDefinition {
    /**
     * The kind(s) that this relation originates from, e.g. "Component" or
     * ["Component", "Resource"].
     */
 ...
 * @alpha
 */
interface CatalogModelUpdateTagDefinition {
    /**
     * The name of the tag, e.g. "java".
     */
    name: string;
 ...
 */
interface CatalogModelLayerBuilder {
    /**
 ...
 */
declare function createCatalogModelLayerBuilder(options: {
    layerId: string;
 ...
 */
declare function createCatalogModelLayer(options: {
    /**
     * The unique ID of the model layer.
     *
     * @remarks
 ...
 */
interface CatalogModelKindRootSchema extends JsonObject {
    type: 'object';
    allOf?: never;
    anyOf?: never;
    oneOf?: never;
 ...
 * @alpha
 */
interface CatalogModelSourceReadOptions {
    signal?: AbortSignal;
}
/**
 ...
 * @alpha
 */
type AsyncCatalogModelSourceGenerator = AsyncGenerator<{
    data: Array<{
 ...
 * @alpha
 */
interface CatalogModelSource {
    /**
     * Returns a stream of layers as expressed by this particular source.
     */
    read(options?: CatalogModelSourceReadOptions): AsyncCatalogModelSourceGenerator;
}
 ...
 * @alpha
 */
declare class CatalogModelSources {
    /**
 ...
 * @alpha
 */
interface AiResourceEntityV1alpha1Default extends Entity$1 {
 ...
 * @alpha
 */
interface SkillAiResourceEntityV1alpha1 extends AiResourceEntityV1alpha1Default {
    spec: {
        type: 'skill';
        lifecycle: string;
        owner: string;
 ...
 * @alpha
 */
interface RuleAiResourceEntityV1alpha1 extends AiResourceEntityV1alpha1Default {
    spec: {
        type: 'rule';
        lifecycle: string;
        owner: string;
 ...
 * @alpha
 */
type AiResourceEntityV1alpha1 = AiResourceEntityV1alpha1Default | SkillAiResourceEntityV1alpha1 | RuleAiResourceEntityV1alpha1;
/**
 * Entity data validator for the default {@link AiResourceEntityV1alpha1}.
 *
 * @alpha
 */
declare const aiResourceEntityV1alpha1Validator: KindValidator;
/**
 * Entity data validator for {@link SkillAiResourceEntityV1alpha1}.
 *
 * @alpha
 */
declare const skillAiResourceEntityV1alpha1Validator: KindValidator;
/**
 * Type guard for {@link AiResourceEntityV1alpha1}.
 *
 * @alpha
 */
declare const isAiResourceEntity: (entity: Entity$1) => entity is AiResourceEntityV1alpha1;
/**
 * Type guard for {@link SkillAiResourceEntityV1alpha1}.
 *
 * @alpha
 */
declare const isSkillAiResourceEntity: (entity: Entity$1) => entity is SkillAiResourceEntityV1alpha1;
/**
 * Type guard for {@link RuleAiResourceEntityV1alpha1}.
 *
 * @alpha
 */
declare const isRuleAiResourceEntity: (entity: Entity$1) => entity is RuleAiResourceEntityV1alpha1;
/**
 * Entity data validator for {@link RuleAiResourceEntityV1alpha1}.
 *
 * @alpha
 */
declare const ruleAiResourceEntityV1alpha1Validator: KindValidator;
/**
 * Extends the catalog model with the AiResource kind.
 *
 * @alpha
 */
declare const aiResourceEntityModel: CatalogModelLayer;
 ...
 * @alpha
 */
interface McpServerApiEntity extends Omit<ApiEntityV1alpha1, 'spec'> {
    spec: {
        type: 'mcp-server';
        lifecycle: string;
        owner: string;
 ...
 * @alpha
 */
declare const mcpServerApiEntityValidator: KindValidator;
/**
 * Type guard: narrows an entity to the MCP server API subtype.
 *
 * @alpha
 */
declare function isMcpServerApiEntity(entity: ApiEntityV1alpha1 | McpServerApiEntity): entity is McpServerApiEntity;
/**
 * Extends the API kind with the mcp-server specType.
 *
 * @alpha
 */
declare const mcpServerApiEntityModel: CatalogModelLayer;
 ...
 * @alpha
 */
declare const defaultCatalogEntityModel: CatalogModelLayer;

export { ApiEntityV1alpha1 as ApiEntity, ApiEntityV1alpha1, CatalogModelSources, Entity$1 as Entity, KindValidator, aiResourceEntityModel, aiResourceEntityV1alpha1Validator, compileCatalogModel, createCatalogModelLayer, createCatalogModelLayerBuilder, defaultCatalogEntityModel, isAiResourceEntity, isMcpServerApiEntity, isRuleAiResourceEntity, isSkillAiResourceEntity, mcpServerApiEntityModel, mcpServerApiEntityValidator, ruleAiResourceEntityV1alpha1Validator, skillAiResourceEntityV1alpha1Validator };
export type { AiResourceEntityV1alpha1, AiResourceEntityV1alpha1Default, AlphaEntity, AsyncCatalogModelSourceGenerator, CatalogModel, CatalogModelAddKindVersionDefinition, CatalogModelAnnotationDefinition, CatalogModelAnnotationSummary, CatalogModelKind, CatalogModelKindDefinition, CatalogModelKindRelationFieldDefinition, CatalogModelKindRootSchema, CatalogModelKindSummary, CatalogModelKindVersionDefinition, CatalogModelLabelDefinition, CatalogModelLabelSummary, CatalogModelLayer, CatalogModelLayerBuilder, CatalogModelRelation, CatalogModelRelationPairDefinition, CatalogModelRelationSummary, CatalogModelRemoveAnnotationDefinition, CatalogModelRemoveKindDefinition, CatalogModelRemoveLabelDefinition, CatalogModelRemoveTagDefinition, CatalogModelSource, CatalogModelSourceReadOptions, CatalogModelTagDefinition, CatalogModelTagSummary, CatalogModelUpdateAnnotationDefinition, CatalogModelUpdateKindDefinition, CatalogModelUpdateKindVersionDefinition, CatalogModelUpdateLabelDefinition, CatalogModelUpdateRelationPairDefinition, CatalogModelUpdateTagDefinition, EntityStatus, EntityStatusItem, EntityStatusLevel, McpServerApiEntity, McpServerRemote, RuleAiResourceEntityV1alpha1, SkillAiResourceEntityV1alpha1 };

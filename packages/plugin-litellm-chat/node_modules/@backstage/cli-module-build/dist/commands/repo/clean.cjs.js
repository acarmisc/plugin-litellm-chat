...
var clean = async ({ args, info }) => {
  cleye.cli({ name: info.usage, booleanFlagNegation: true }, void 0, args);
    ...
    Array.from(Array(10), async () => {
      while (packages.length > 0) {
        ...
        if (cleanScript === "backstage-cli clean" || cleanScript === "backstage-cli package clean") {
          await fs__default.default.remove(node_path.resolve(pkg.dir, "dist"));
          await fs__default.default.remove(node_path.resolve(pkg.dir, "dist-types"));
          await fs__default.default.remove(node_path.resolve(pkg.dir, "coverage"));
        } else if (cleanScript) {

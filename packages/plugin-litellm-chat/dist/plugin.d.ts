...
export declare const litellmChatPlugin: import("@backstage/frontend-plugin-api").OverridableFrontendPlugin<{}, {}, {
    "api:litellm-chat": import("@backstage/frontend-plugin-api").OverridableExtensionDefinition<{
        kind: "api";
        name: undefined;
        config: {};
        configInput: {};
    ...
    "page:litellm-chat": import("@backstage/frontend-plugin-api").OverridableExtensionDefinition<{
        kind: "page";
        name: undefined;
        config: {
